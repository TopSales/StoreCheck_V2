...
namespace StoreCheck.Pages
{
   ...
   public partial class StorePage : Page_Base
   {
      ...
      {
         var posD = await Xamarin.Essentials.Geolocation.GetLastKnownLocationAsync();
      ...
      private async void listView_ItemSelected(object sender, SelectedItemChangedEventArgs e)
      {
         if (e.SelectedItem != null)
         {
            ...
            {
               await DisplayAlertT("Error", "You can't access a validated intervention!", "ok");
            }
            else
            {
