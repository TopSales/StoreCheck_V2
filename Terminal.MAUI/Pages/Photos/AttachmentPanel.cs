...
namespace ZPF.XF
{
   public class AttachmentPanel : Grid
   {
      ...
      {
         // https://docs.microsoft.com/en-us/dotnet/maui/platform-integration/device-media/picker?tabs=windows
