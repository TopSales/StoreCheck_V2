...
public class UnitechViewModel : BaseViewModel
{
   ...
   public delegate bool OnScannHandler(string data, int length, Symbologies symbology, byte[] rawData);
   public OnScannHandler OnScann { get; internal set; }
   ...
   public void NewBarcode(string data, int length, byte symbology, byte[] rawData)
   {
      ...
      if (OnScann != null)
      {
         if (OnScann(data, length, Symbology, rawData))
         {
            return;
         };
      };
   ...
   public void Scanner_Enable(OnScannHandler onScann)
   {
   ...
   public void Scanner_Disable(OnScannHandler onScann)
   {
